...
console.log('step one', array1);
console.log('step two', array1[2]);
console.log('step three', array1[array1.length - 1]);
array1.push(16, 3);
console.log('step four', array1);
console.log('step five', array1[2]);
console.log('step six', array1[array1.length - 1]);
...
function reverse(x) {
       switch (typeof x) {
              ...
              case 'object':
              if (Array.isArray(x)) {
                     return x.map(item => reverse(item)). reverse();
              }
              default:
                     return false;
       }
